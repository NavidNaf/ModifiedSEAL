...
namespace seal
{
    ...
    void Decryptor::dot_product_ct_sk_array(const Ciphertext &encrypted, RNSIter destination, MemoryPoolHandle pool)
    {
        ...
        std::printf(
            "[rdtsc] Decryptor::dot_product_ct_sk_array branch_entry=%llu\n",
        ...
        if (encrypted_size == 2)
        {
            ...
            std::printf(
                "[rdtsc] Decryptor::dot_product_ct_sk_array t1=%llu\n",
        ...
        else
        {
            ...
            std::printf(
                "[rdtsc] Decryptor::dot_product_ct_sk_array t2=%llu\n",
            ...
            std::printf(
                "[rdtsc] Decryptor::dot_product_ct_sk_array t3=%llu\n",
            ...
            std::printf(
                "[rdtsc] Decryptor::dot_product_ct_sk_array t4=%llu\n",
